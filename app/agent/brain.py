...
def build_agent_graph() -> StateGraph:
    ...
    workflow.add_node("run_hybrid_tools",      run_hybrid_tools)
    ...
    workflow.add_conditional_edges("classify_intent", route_by_intent, {
        ...
        "run_hybrid_tools":  "run_hybrid_tools",
    })

    workflow.add_edge("run_tool_call",         "tools")
    workflow.add_edge("tools",                 "generate_final_answer")

    workflow.add_edge("ask_clarification",     END)
    workflow.add_edge("reject_query",          END)
    workflow.add_edge("run_hybrid_tools",      END)
